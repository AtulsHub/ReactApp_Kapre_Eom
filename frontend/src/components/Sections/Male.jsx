...
const Male = ({ category, page, limit, className }) => {
    ...
    <section className="">
      <div className=" flex gap-4 h-124 bg-cyan-900 py-8  px-12 ">
        <div className="flex flex-col justify-between w-1/2 h-full  ">
          <h1 className="text-cyan-200 bg-cyan-900 text-4xl pl-4">
          ...
          <div className="flex justify-center items-center h-full  ">
            ...
            <div className="content-center border-0.5 h-96 w-48 px-2 relative z-20 shadow-2xl shadow-blue-200 rounded-2xl">
              <ImageSlider
                category={category}
                sNum={2}
